...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Complect.ItemComplectEntity", b =>
                {
                    ...
                    b.Property<int?>("ItemsComplectEFentityId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ItemsComplectEFentityId");
            ...
            modelBuilder.Entity("Domain.Services.Entity.Service", b =>
                {
                    ...
                    b.Property<int?>("ServiceComplectEFentityId")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.HasIndex("ServiceComplectEFentityId");

                    b.ToTable("Service");
                });

            modelBuilder.Entity("Infrastructure.Model.Issue.IssueEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Infrastructure.Model.Issue.ItemsComplectEFentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("IssueComplect");
                });

            modelBuilder.Entity("Infrastructure.Model.Issue.ServiceComplectEFentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Complect.ItemComplectEntity", b =>
                {
                    b.HasOne("Infrastructure.Model.Issue.ItemsComplectEFentity", null)
                        .WithMany("Items")
                        .HasForeignKey("ItemsComplectEFentityId");
                });
            ...
            modelBuilder.Entity("Domain.Services.Entity.Service", b =>
                {
                    b.HasOne("Infrastructure.Model.Issue.ServiceComplectEFentity", null)
                        .WithMany("Services")
                        .HasForeignKey("ServiceComplectEFentityId");
                });
